    ...
    try:
        ...
        for i in range(1, len(rows)):
            ...
            if len(rows[i]) >= 3:
                ...
                print()
                # Strongly recommend, recommend, neutral, don't recommend, strongly don't recommend
                sentiment = input("Enter sentiment (sr, r, neu, dr, sdr): ").strip().lower()
                ...
                if sentiment in ['q', 'quit']:
                    ...
                    break
                while sentiment not in ['sr', 'r', 'neu', 'dr', 'sdr']:
...
label_reviews('reviews_relabeled.csv')
